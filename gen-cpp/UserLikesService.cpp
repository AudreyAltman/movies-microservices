...
void UserLikesServiceClient::UserRateMovie(const int64_t user_id, const std::string& movie_id, const int64_t likeDislike)
{
  send_UserRateMovie(user_id, movie_id, likeDislike);
  recv_UserRateMovie();
}

void UserLikesServiceClient::send_UserRateMovie(const int64_t user_id, const std::string& movie_id, const int64_t likeDislike)
{
  int32_t cseqid = 0;
...
void UserLikesServiceClient::GetUsersLikedMovies(std::vector<std::string> & _return, const int64_t user_id)
{
  send_GetUsersLikedMovies(user_id);
  recv_GetUsersLikedMovies(_return);
}

void UserLikesServiceClient::send_GetUsersLikedMovies(const int64_t user_id)
{
  int32_t cseqid = 0;
...
void UserLikesServiceClient::UserWatchMovie(const int64_t user_id, const std::string& movie_id)
{
  send_UserWatchMovie(user_id, movie_id);
  recv_UserWatchMovie();
}

void UserLikesServiceClient::send_UserWatchMovie(const int64_t user_id, const std::string& movie_id)
{
  int32_t cseqid = 0;
...
int64_t UserLikesServiceClient::GetUserID(const std::string& user_name)
{
...
int64_t UserLikesServiceClient::recv_GetUserID()
{
...
void UserLikesServiceProcessor::process_GetUserID(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->GetUserID(args.user_name);
    result.__isset.success = true;
  } catch (ServiceException &se) {
    result.se = se;
    result.__isset.se = true;
...
void UserLikesServiceConcurrentClient::UserRateMovie(const int64_t user_id, const std::string& movie_id, const int64_t likeDislike)
{
  int32_t seqid = send_UserRateMovie(user_id, movie_id, likeDislike);
  recv_UserRateMovie(seqid);
}

int32_t UserLikesServiceConcurrentClient::send_UserRateMovie(const int64_t user_id, const std::string& movie_id, const int64_t likeDislike)
{
...
void UserLikesServiceConcurrentClient::GetUsersLikedMovies(std::vector<std::string> & _return, const int64_t user_id)
{
  int32_t seqid = send_GetUsersLikedMovies(user_id);
  recv_GetUsersLikedMovies(_return, seqid);
}

int32_t UserLikesServiceConcurrentClient::send_GetUsersLikedMovies(const int64_t user_id)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("GetUsersLikedMovies", ::apache::thrift::protocol::T_CALL, cseqid);
...
void UserLikesServiceConcurrentClient::UserWatchMovie(const int64_t user_id, const std::string& movie_id)
{
  int32_t seqid = send_UserWatchMovie(user_id, movie_id);
  recv_UserWatchMovie(seqid);
}

int32_t UserLikesServiceConcurrentClient::send_UserWatchMovie(const int64_t user_id, const std::string& movie_id)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("UserWatchMovie", ::apache::thrift::protocol::T_CALL, cseqid);
...
int64_t UserLikesServiceConcurrentClient::GetUserID(const std::string& user_name)
{
...
int64_t UserLikesServiceConcurrentClient::recv_GetUserID(const int32_t seqid)
{
