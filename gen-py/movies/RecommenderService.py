...
class Client(Iface):
    ...
    def GetRecommendations(self, user):
        ...
        return self.recv_GetRecommendations()

    def send_GetRecommendations(self, user):
        self._oprot.writeMessageBegin('GetRecommendations', TMessageType.CALL, self._seqid)
    ...
    def recv_GetRecommendations(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
...
class Processor(Iface, TProcessor):
    ...
    def process_GetRecommendations(self, seqid, iprot, oprot):
        ...
        result = GetRecommendations_result()
        try:
            result.success = self._handler.GetRecommendations(args.user)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except ServiceException as se:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("GetRecommendations", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class GetRecommendations_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetRecommendations_args)
GetRecommendations_args.thrift_spec = (
    None,  # 0
...
class GetRecommendations_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetRecommendations_result)
GetRecommendations_result.thrift_spec = (
